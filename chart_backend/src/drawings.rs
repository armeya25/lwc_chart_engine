...
pub struct DrawingTool {
    ...
    pub line_tools: HashMap<String, Value>, // trendlines, rays, fibs
    #[pyo3(get)]
    pub chart_positions: HashMap<String, String>, // chart_id -> pos_id
    pub category_index: HashMap<String, HashSet<String>>, // category -> set of box_ids
    #[pyo3(get)]
